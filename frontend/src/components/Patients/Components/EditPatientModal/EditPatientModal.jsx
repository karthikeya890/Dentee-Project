...
const EditPatientModal = (info) => {
  const [updatePatient, { isSuccess, isError, data, error }] =
  ...
  useEffect(() => {
    ...
    if (isSuccess) {
      ...
      console.log("printed success update");
    } else if (isError) {
